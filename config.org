...
Ivy is a generic completion framework which can filter a list of "things", e.g. filenames.
...
Counsel can do a great many things:
...
It also brings in Ivy and Swiper as dependencies.
