  ...
  ;; The old bullets in case I change my mind ("✸" "◇" "•" "○" "✤" "✩")
    ...
    (add-hook 'org-mode-hook
              (lambda ()
                ...
                ;; (setq org-babel-haskell-compiler "runhaskell")
                ;; (setq org-ellipsis "⤵")
...
#+begin_src emacs-lisp
   (defun run-haskell-project ()
     (interactive)
     (shell-command "cabal run"))

  (defun build-haskell-project ()
     (interactive)
  ...
  (use-package haskell-mode
    ...
    ;; (add-hook 'haskell-mode-hook (lambda () (flymake-hlint-load))) ;; Nice, but also a tad obnoxious
    (define-key haskell-mode-map (kbd "s-r") 'run-haskell-project)
    (define-key haskell-mode-map (kbd "s-b") 'build-haskell-project)
    (add-hook 'haskell-mode-hook 'prettify-symbols-mode)
    (setq-default prettify-symbols-alist '(("\\" . "λ")))
    )
  ...
  (use-package dante
    ...
    :bind (:map haskell-mode-map ("C-M-x" . dante-eval-block))
    )
