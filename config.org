...
Good old Ido, I primarily use it for finding (opening) files.
...
#+begin_src emacs-lisp
  ...
  ;; Replacement for ido-ubiquitous, might not be needed anymore?
  (use-package ido-completing-read+
    :ensure t)
#+end_src

Smex is a better M-x that still feels like home.
...
Counsel has a bunch of functions for finding things, e.g. 'counsel-git'. It also brings in Ivy and Swiper as dependencies.
...
Ivy is a generic completion framework which can filter a list of "things", e.g. filenames or buffers.
