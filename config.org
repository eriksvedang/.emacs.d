...
** Haskell
#+begin_src emacs-lisp
   (defun run-stack-project ()
     (interactive)
     (shell-command "stack run"))

  (defun build-stack-project ()
     (interactive)
     (shell-command "stack build"))
  ...
  (use-package haskell-mode
    ...
    (add-hook 'haskell-mode-hook (lambda () (flymake-hlint-load)))
    (define-key haskell-mode-map (kbd "s-r") 'run-stack-project)
    (define-key haskell-mode-map (kbd "s-b") 'build-stack-project)
