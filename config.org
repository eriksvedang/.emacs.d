...
from the excellent Nano configuration, see [[nano-theme.el][https://github.com/rougier/nano-emacs]].
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Mode Line
See [[nano-modeline.el][https://github.com/rougier/nano-emacs]].
#+BEGIN_SRC emacs-lisp
