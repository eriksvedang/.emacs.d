...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:foreground "#fff" :background "#271c4b"))))
 '(mode-line-buffer-id ((t (:foreground "#fff"))))
 '(powerline-active1 ((t (:foreground "#271c4b" :background "gray92"))))
 '(powerline-active2 ((t (:foreground "#fff" :background "#271c4b"))))
