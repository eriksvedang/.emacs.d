...
(custom-theme-set-faces
 ...
 ;; #0072b2
 ;; #148
 '(font-lock-builtin-face ((t (:weight normal :foreground "#CFF"))))

 ;; #5f74b8
 ;; #09d
 '(font-lock-keyword-face ((t (:foreground "#147" :weight normal))))

 '(haskell-keyword-face ((t (:foreground "#FFF" :weight normal))))
 '(haskell-definition-face ((t (:foreground "#FFF" :weight normal))))
 '(haskell-operator-face ((t (:foreground "#FFF" :weight normal))))
 ...
 '(font-lock-string-face ((t (:foreground "#9DD"))))
 ...
 ;; #09D
 ;; #FAF
 '(font-lock-type-face ((t (:foreground "#FAF" :weight normal))))
 ...
 '(rainbow-delimiters-depth-7-face ((t (:foreground "#FFF"))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "#FFF"))))
 '(rainbow-delimiters-depth-9-face ((t (:foreground "#FFF"))))
 '(rainbow-delimiters-depth-10-face ((t (:foreground "#FFF"))))
 '(rainbow-delimiters-depth-11-face ((t (:foreground "#FFF"))))
 '(rainbow-delimiters-depth-12-face ((t (:foreground "#FFF"))))
 
 '(rainbow-delimiters-unmatched-face ((t (:background "#F99"))))

 ;; #DFF
 ;; #AFF
 '(show-paren-match ((t (:background "#077" :underline nil :weight bold))))
 ...
 ;; a6a6a6 aaa
 '(font-lock-comment-face ((t (:foreground "#333" :background nil :weight bold :slant italic))))
